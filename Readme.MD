...
## 5. 느낀 점
-	기획에 매우 공을 들였고 실제 개발시 꼼꼼한 기획으로 시행착오를 줄일 수 있어 기획의 중요성을 다시 깨달음  

-	코드는 어떻게든 짤 수 있으나 중요한 건 튼튼하고 간결하면서 가독성 좋은 코드를 짜는 것임

-	좋은 동료의 소중함과 감사함 (이슈 발생시 대처가 이 팀만 같다면 못 할 일이 없다는 생각이 들었음)
